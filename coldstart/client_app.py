...
from coldstart.task import Net, load_data
from coldstart.task import test as test_fn
from coldstart.task import train as train_fn
from coldstart.util import PARTITION_HOSPITAL_MAP
