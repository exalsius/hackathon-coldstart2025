...
def preprocess_dataset(dataset_name, image_size):
    ...
    output_path = f"{SRC_DIR}_preprocessed_{image_size}/{dataset_name}"
    ...
    preprocessed = DatasetDict({split_name: transform_split(ds, split_name, image_size) for split_name, ds in dataset.items()})
